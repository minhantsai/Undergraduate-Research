...
% Last Modified by GUIDE v2.5 28-Dec-2018 08:52:15
...
set(handles.text20,'String',"connecting");
handles.bt=Bluetooth('HC-05',1);
fopen(handles.bt);
set(handles.text20,'String',"connected");
guidata(hObject,handles);
...
fclose(handles.bt);
clear('handles.bt');
set(handles.text20,'String',"unconnected");
